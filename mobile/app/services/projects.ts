...
export async function updateColumnInProject(projectId: string, updatedColumns: any[]): Promise<void> {
  const collectionRef = getProjectsCollectionRef();
  await collectionRef.doc(projectId).update({
...
export async function deleteColumnFromProject(projectId: string, column: any): Promise<void> {
  const collectionRef = getProjectsCollectionRef();
  await collectionRef.doc(projectId).update({
